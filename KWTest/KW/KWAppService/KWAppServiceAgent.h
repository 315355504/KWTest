...
#import "KWAppServiceUploadFile.h"

/**
 *  传输方式
 */
typedef NS_ENUM(NSInteger, KWAppServiceMethod) {
    /**
     *  GET
     */
    KWAppServiceMethodGET = 0,
    /**
     *  HEAD
     */
    KWAppServiceMethodHEAD = 1,
    /**
     *  POST
     */
    KWAppServiceMethodPOST = 2,
    /**
     *  PUT
     */
    KWAppServiceMethodPUT = 3,
    /**
     *  PATCH
     */
    KWAppServiceMethodPATCH = 4,
    /**
     *  DELETE
     */
    KWAppServiceMethodDELETE = 5,
};

@interface KWAppServiceAgent : NSObject
/**
 *  自定义配置文件
 */
@property (nonatomic, strong) KWAppServiceConfig *defaultConfig;
