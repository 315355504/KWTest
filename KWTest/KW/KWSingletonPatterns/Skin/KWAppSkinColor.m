...
#import "UIColor+Palette.h"
@implementation KWAppSkinColor

static  KWAppSkinColor *sharedInstance = nil;
...
+(instancetype) sharedInstance {
    ...
    dispatch_once(&oncePredicate, ^{
        sharedInstance = [[KWAppSkinColor alloc] init];
        });
...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        _normalNavigationBarColor = [UIColor colorFromHexString:@"#F9F9F9"];
